...
export const buttonVariants = cva("transition-all", {
  variants: {
    variant: {
      primary:
        "border-neutral-900 bg-neutral-900 text-white hover:bg-neutral-800 hover:ring-4 hover:ring-neutral-200/60 dark:border-white dark:bg-white dark:text-black dark:hover:bg-neutral-50 dark:hover:ring-white/10",
      secondary: cn(
        "border-neutral-200 bg-white text-neutral-900 hover:bg-neutral-50 outline-none dark:border-white/10 dark:bg-black dark:text-white dark:hover:bg-neutral-900",
        "data-[state=open]:ring-4 data-[state=open]:ring-neutral-200/50",
      ),
      outline: "border-transparent text-neutral-700 hover:bg-neutral-100 dark:text-white/80 dark:hover:bg-white/10",
      success:
      ...
      pro:
        "border-[var(--tertiary-strong)] bg-[var(--tertiary-strong)] text-white hover:ring-4 hover:ring-[var(--tertiary)]/30 hover:shadow-lg hover:shadow-[var(--tertiary)]/20",
    },
  },
  defaultVariants: {
    variant: "primary",
  ...
  (
    ...
    return (
      <Component
        ...
        {...(as ? {} : { type: props.onClick ? "button" : "submit" })}
        className={cn(
