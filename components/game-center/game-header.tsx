  ...
  return (
    <div className="rounded-xl bg-white dark:bg-neutral-900 border border-neutral-200/60 dark:border-neutral-800/60 overflow-hidden">
      ...
      <div className="relative px-6 py-5">
        {/* Subtle gradient wash behind team logos */}
        ...
        <div className="relative flex items-center justify-between">
          ...
          <div className="flex flex-col items-center gap-1 px-4 shrink-0">
            ...
            {w?.venue_name && (
              <div className="text-[11px] text-neutral-400 whitespace-nowrap">{w.venue_name}</div>
            )}
            {/* Odds strip */}
            {odds && (
          ...
          {/* Home team */}
          <div className="flex items-center gap-4 min-w-0 flex-row-reverse">
            <img
      ...
      {/* Bottom strip: weather + park factor */}
      {(w || game.park_factor != null) && (
        <div className="flex items-center justify-center gap-5 px-4 py-2 border-t border-neutral-100 dark:border-neutral-800/40 bg-neutral-50/50 dark:bg-neutral-800/10">
          {w?.temperature_f != null && (
            <div className="flex items-center gap-1.5 text-xs text-neutral-600 dark:text-neutral-400">
              <Thermometer className="w-3.5 h-3.5 text-neutral-400" />
              <span className="font-semibold text-neutral-900 dark:text-white">{w.temperature_f}°F</span>
            </div>
          )}
          ...
          {w?.hr_impact_score != null && !isRetractable && (
            <div className="flex items-center gap-1.5 text-xs">
              ...
              <span className={cn(
                ...
                w.hr_impact_score >= 4 ? "text-[#16A34A] dark:text-[#4ADE80]" :
                w.hr_impact_score <= -4 ? "text-[#FC1414] dark:text-[#F87171]" :
                "text-neutral-500"
              )}>
    ...
    <div className="rounded-xl bg-white dark:bg-neutral-900 border border-neutral-200/60 dark:border-neutral-800/60 overflow-hidden">
      ...
      {(w || game.park_factor != null) && (
        <div className="flex items-center justify-center gap-4 px-3 py-2 border-t border-neutral-100 dark:border-neutral-800/40 bg-neutral-50/50 dark:bg-neutral-800/10 flex-wrap">
          ...
          {w?.temperature_f != null && (
            <span className="text-[10px] font-semibold text-neutral-900 dark:text-white">{w.temperature_f}°F</span>
          )}
          {w?.wind_speed_mph != null && w.wind_speed_mph > 0 && !isRetractable && (
