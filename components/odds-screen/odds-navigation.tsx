...
const PRIMARY_MARKETS: Record<string, MarketTab[]> = {
  ...
  nfl: [
    { id: "pass_yds", label: "Pass Yds", apiKey: "passing_yards", type: "player" },
    { id: "pass_tds", label: "Pass TDs", apiKey: "passing_tds", type: "player" },
    { id: "rush_yds", label: "Rush Yds", apiKey: "rushing_yards", type: "player" },
    { id: "rec_yds", label: "Rec Yds", apiKey: "receiving_yards", type: "player" },
    { id: "receptions", label: "Rec", apiKey: "receptions", type: "player" },
    { id: "atd", label: "ATD", apiKey: "player_touchdowns", type: "player" },
    { id: "ftd", label: "1st TD", apiKey: "first_td", type: "player" },
  ],
  nhl: [
...
const SECONDARY_MARKETS: Record<string, MarketTab[]> = {
  ...
  nfl: [
    { id: "last_td", label: "Last TD", apiKey: "last_td", type: "player" },
    ...
    { id: "int", label: "INTs Thrown", apiKey: "pass_interceptions", type: "player" },
    { id: "rush_att", label: "Rush Attempts", apiKey: "rush_attempts", type: "player" },
    { id: "pass_rush", label: "Pass + Rush Yds", apiKey: "pass_rush_yards", type: "player" },
    { id: "rush_rec", label: "Rush + Rec Yds", apiKey: "rush_rec_yards", type: "player" },
    { id: "longest_pass", label: "Longest Pass", apiKey: "longest_pass", type: "player" },
    { id: "longest_rush", label: "Longest Rush", apiKey: "longest_rush", type: "player" },
    { id: "longest_rec", label: "Longest Reception", apiKey: "longest_reception", type: "player" },
  ...
  nhl: [
    { id: "saves", label: "Saves", apiKey: "player_total_saves", type: "player" },
    { id: "last_goal", label: "Last Goalscorer", apiKey: "player_last_goal", type: "player" },
...
const PRIMARY_GAME_MARKETS: Record<string, MarketTab[]> = {
  ...
  nhl: [
    { id: "ml", label: "ML", apiKey: "moneyline", type: "game" },
    { id: "puck_line", label: "Puck Line", apiKey: "puck_line", type: "game" },
    { id: "total", label: "Total", apiKey: "total_goals", type: "game" },
    { id: "ml_3way", label: "ML 3-Way", apiKey: "moneyline_3way", type: "game" },
    { id: "p1_ml", label: "P1 ML", apiKey: "p1_moneyline", type: "game" },
    { id: "p1_total", label: "P1 Total", apiKey: "p1_total_goals", type: "game" },
  ],
  ncaab: [
    { id: "ml", label: "ML", apiKey: "moneyline", type: "game" },
    { id: "spread", label: "Spread", apiKey: "spread", type: "game" },
  ...
  mlb: [
    { id: "ml", label: "ML", apiKey: "moneyline", type: "game" },
    { id: "spread", label: "Run Line", apiKey: "spread", type: "game" },
    { id: "total", label: "Total", apiKey: "total", type: "game" },
  ],
};
...
const SECONDARY_GAME_MARKETS: Record<string, MarketTab[]> = {
  ...
  nfl: [
    { id: "1q_ml", label: "1Q Moneyline", apiKey: "1q_moneyline", type: "game" },
    { id: "1q_spread", label: "1Q Spread", apiKey: "1q_spread", type: "game" },
    { id: "1q_total", label: "1Q Total", apiKey: "1q_total", type: "game" },
    { id: "2h_total", label: "2H Total", apiKey: "2h_total", type: "game" },
    { id: "home_total", label: "Home Total", apiKey: "home_total", type: "game" },
    { id: "away_total", label: "Away Total", apiKey: "away_total", type: "game" },
    { id: "total_tds", label: "Total TDs", apiKey: "total_touchdowns", type: "game" },
    { id: "overtime", label: "Overtime?", apiKey: "overtime", type: "game" },
  ],
  nhl: [
    { id: "total_reg", label: "Total (Reg)", apiKey: "total_goals_reg", type: "game" },
    { id: "puck_reg", label: "Puck Line (Reg)", apiKey: "puck_line_reg", type: "game" },
    { id: "p2_ml", label: "P2 Moneyline", apiKey: "p2_moneyline", type: "game" },
    { id: "p2_total", label: "P2 Total", apiKey: "p2_total_goals", type: "game" },
    { id: "p3_ml", label: "P3 Moneyline", apiKey: "p3_moneyline", type: "game" },
    { id: "p3_total", label: "P3 Total", apiKey: "p3_total_goals", type: "game" },
    ...
    { id: "home_total", label: "Home Total", apiKey: "home_total_goals", type: "game" },
    { id: "away_total", label: "Away Total", apiKey: "away_total_goals", type: "game" },
  ],
  ncaab: [
    { id: "1q_ml", label: "1Q Moneyline", apiKey: "1q_moneyline", type: "game" },
    { id: "1q_spread", label: "1Q Spread", apiKey: "1q_spread", type: "game" },
