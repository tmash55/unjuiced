...
const MARKETS: MarketConfig[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "recent_ba", label: "Recent", shortLabel: "Rec BA", format: "avg", tooltip: "Recent batting average" },
  ...
  },
  {
    ...
    factors: [
      { key: "speed", label: "Speed", tooltip: "Sprint speed + SB success rate" },
      { key: "volume", label: "Volume", tooltip: "SB per game rate + attempt frequency" },
      { key: "attempt_rate", label: "Attempt Rate", tooltip: "How often this player attempts to steal" },
      { key: "recent", label: "Recent", tooltip: "Last 15 games SB average + attempt rate" },
      { key: "opp_pitcher", label: "Pitcher", tooltip: "Opposing pitcher SB allowed/start + CS rate" },
      { key: "obp", label: "OBP", tooltip: "On-base percentage — opportunity to get on base" },
    ],
  },
  {
    key: "pitcher_h",
    ...
    columns: [
      ...
      { key: "recent_h_per_9", label: "Rec H/9", shortLabel: "Rec", format: "stat", tooltip: "Recent starts H/9" },
      { key: "opp_lineup_ba", label: "Opp BA", shortLabel: "Opp", format: "avg", tooltip: "Opposing lineup batting average" },
    ],
    factors: [
      { key: "h9", label: "H/9" },
      { key: "recent_h9", label: "Recent" },
      { key: "hard_hit", label: "Hard Hit" },
      { key: "gb_rate", label: "GB Rate" },
      { key: "opp_ba", label: "Opp BA" },
      { key: "ballpark", label: "Ballpark" },
    ],
  },
  {
...
const MARKET_STATS: Record<string, StatDisplayItem[]> = {
  ...
  hits: [
    ...
    { key: "k_rate", label: "K Rate", format: "pct", group: "Contact" },
    { key: "babip", label: "BABIP", format: "avg", group: "Contact" },
    { key: "bvp_avg", label: "BvP AVG", format: "avg", group: "Matchup" },
    { key: "bvp_pa", label: "BvP PA", format: "int", group: "Matchup" },
  ],
  tb: [
  ...
  sb: [
    { key: "sprint_speed", label: "Sprint Speed (ft/s)", format: "stat", group: "Speed" },
    { key: "success_rate", label: "SB Success Rate", format: "pct100", group: "Speed" },
    { key: "sb_total", label: "Season SB", format: "int", group: "Volume" },
    { key: "cs_total", label: "Caught Stealing", format: "int", group: "Volume" },
    { key: "sb_attempt_rate", label: "Attempt Rate", format: "pct100", group: "Volume" },
    { key: "obp", label: "OBP", format: "avg", group: "Opportunity" },
    { key: "recent_sb_avg", label: "Recent SB/Game", format: "stat", group: "Recent" },
  ],
  pitcher_h: [
    { key: "h_per_9", label: "H/9", format: "stat", group: "Hits Allowed" },
    { key: "recent_h_per_9", label: "Recent H/9", format: "stat", group: "Hits Allowed" },
    { key: "hard_hit_against", label: "Hard Hit% Against", format: "pct", group: "Hits Allowed" },
    { key: "gb_rate", label: "Ground Ball%", format: "pct", group: "Hits Allowed" },
    { key: "opp_lineup_ba", label: "Opp Lineup BA", format: "avg", group: "Opponent" },
  ],
  pitcher_er: [
