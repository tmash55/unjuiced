...
// Book odds data structure (for type safety within this component)
...
// Odds Dropdown Component
function OddsDropdownCell({ 
  odds, 
  line,
  isLive 
}: { 
...
export function CheatSheetTable({ rows, isLoading, oddsData, isLoadingOdds, timeWindow, onRowClick, onGlossaryOpen }: CheatSheetTableProps) {
