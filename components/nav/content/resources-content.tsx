...
const mainLinks = [
  ...
  },
  {
    icon: Calculator,
    title: "Calculators",
    description: "Value, hedge, and hold calculators",
    href: "/calculators",
    comingSoon: true,
  },
];
          ...
          {[
            {
              ...
              href: "/about",
              icon: <Users className="size-4 text-neutral-600 transition-colors dark:text-white/60" />,
            },
            {
              title: "Contact",
              description: "Reach out to support or sales",
              href: "/contact",
              icon: <Mail className="size-4 text-neutral-600 transition-colors dark:text-white/60" />,
            },
            ...
            <ContentLinkCard
              ...
              icon={<div className="shrink-0 rounded-md border border-neutral-200 bg-white/50 p-2.5 dark:border-white/20 dark:bg-white/10">{icon}</div>}
              title={title}
          ...
          {[
            {
              ...
              href: "/blog",
              icon: <Feather className="size-4 text-neutral-600 transition-colors dark:text-white/60" />,
            },
            {
              title: "Changelog",
              description: "Releases and updates",
              href: "/changelog",
              icon: <ListChecks className="size-4 text-neutral-600 transition-colors dark:text-white/60" />,
            },
          ].map(({ title, description, href, icon }) => (
            <ContentLinkCard
              key={href}
